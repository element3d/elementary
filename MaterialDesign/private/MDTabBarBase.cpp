...
MDTabBarBase::MDTabBarBase()
	: e3::ScrollView()
{
        this->SetOrientation((EOrientation)0);
        ...
        pElement1->SetOrientation((EOrientation)1);
        pElement1->SetAlignItemsHor((e3::EAlignment)0);
        mContent = e3::ViewFactory::CreateShape( EOrientation::Horizontal);
        ...
        mSelection = e3::ViewFactory::CreateShape( EOrientation::Horizontal);
